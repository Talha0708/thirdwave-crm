...
const AuthPage = () => {
    // ✅ FIX: Extract context loading to prevent UI flash
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/dashboard', { replace: true }); // Prevent back-button navigation to login
        } catch (err) {
    ...
    // ✅ FIX: Show a full-screen loader while checking auth state from localStorage
    if (contextLoading) {
        return (
